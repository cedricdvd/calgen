const exampleClasses = {
    'COGS 108': {
        'A00': {
            'LE': {'Days': 'MWF', 'Time': '10:00a-10:50a', 'Building': 'GH', 'Room': '242'},
            'LA': {
        ...
        'B00': {
            'LE': {'Days': 'MWF', 'Time': '2:00p-2:50p', 'Building': 'YORK', 'Room': '2722'},
            'LA': {
    ...
    'MATH 20C': {
        'A00': {
            'LE': {'Days': 'TuTh', 'Time': '9:30a-10:50a', 'Building': 'JEANN', 'Room': 'AUD'},
            'DI': {
        ...
        'B00': {
            'LE': {'Days': 'MWF', 'Time': '8:00a-8:50a', 'Building': 'WLH', 'Room': '2005'},
            'DI': {
        ...
        'C00': {
            'LE': {'Days': 'MWF', 'Time': '4:00p-4:50p', 'Building': 'CENTR', 'Room': '119'},
            'DI': {
    ...
    'CSE 120': {
        'A00': {
            'LE': {'Days': 'TuTh', 'Time': '8:00a-9:20a', 'Building': 'MOS', 'Room': '0114'},
            'DI': {'Days': 'M', 'Time': '5:00p-5:50p', 'Building': 'PETER', 'Room': '110'},
            'FI': {'Days': 'W', 'Time': '8:00a-10:59a', 'Date': '12/10/2024'}
        }
    },
    'CSE 170': {
        'A00': {
            'LE': {'Days': 'MWF', 'Time': '1:00p-1:50p', 'Building': 'CENTR', 'Room': '105'},
            'ST': {
